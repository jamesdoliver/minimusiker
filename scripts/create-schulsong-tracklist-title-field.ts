/**
 * Script to create the schulsong_tracklist_title field on the Events Airtable table
 * and update the field ID in the codebase.
 *
 * Run with: npx tsx scripts/create-schulsong-tracklist-title-field.ts
 *
 * Creates 1 field:
 *   1. schulsong_tracklist_title (singleLineText) - custom title for schulsong on CD booklet
 *
...
async function main() {
  ...
  console.log('Creating schulsong_tracklist_title field on Events table');
