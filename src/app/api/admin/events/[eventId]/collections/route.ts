...
/**
 * GET /api/admin/events/[eventId]/collections
...
/**
 * POST /api/admin/events/[eventId]/collections
 * Create a new collection (Choir or Teacher Song) for an event (admin only)
 */
export async function POST(
  ...
  try {
    ...
    // Get event detail to verify it exists
